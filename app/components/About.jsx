  ...
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col  lg:flex-row items-center gap-20 my-20">
        <Card setShowCard={setShowCard} className={showCard ? "" : "hidden"} />
        ...
        <div className="flex-1">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
            {infoList.map((item  ,index )=>(
              ...
              key={index} className=" hover:bg-[#fcf4ff] hover:shadow-[4px_4px_0px_#000] border-[0.5px] hover:-translate-y-1 duration-500 border-gray-400 rounded-xl p-6 cursor-pointer">
